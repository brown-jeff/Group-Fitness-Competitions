...
enum DeepLink: Equatable {
    ...
    private enum Constants {
        static let baseURL = URL(string: "https://google.com/")! // next sprint, possibly
...
extension DeepLink: Sharable {
    var itemsForSharing: [Any] {
        ...
        switch self {
        case .friendReferral:
            text = "Add me in Group Fitness Competitions!"
        case .competitionInvite:
            text = "Compete against me in Group Fitness Competitions!"
        }
